...
class EnterpriseCreateView(CreateView):
    ...
    model = Enterprise
    template_name = "enterprise/enterprise_form.html"
    success_url = reverse_lazy("enterprise_list")

class EnterpriseUpdateView(UpdateView):
    form_class = EnterpriseEditForm
    model = Enterprise
    template_name = "enterprise/enterprise_edit_form.html"
    success_url = reverse_lazy("enterprise_list")

class EnterpriseListView(ListView):
    template_name = "enterprise/enterpriselist.html"
...
class EnterpriseDeactivateView(UpdateView):
    ...
    model = Enterprise
    template_name = "enterprise/deactivate_enterprise_account.html"
    success_url = reverse_lazy("enterprise_list")
